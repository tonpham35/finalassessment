...
RSpec.describe InvestmentsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      investment = Investment.create! valid_attributes
      get :show, params: {id: investment.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      investment = Investment.create! valid_attributes
      get :edit, params: {id: investment.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {investment: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the investment" do
        investment = Investment.create! valid_attributes
        put :update, params: {id: investment.to_param, investment: valid_attributes}, session: valid_session
  ...
  describe "DELETE #destroy" do
    it "destroys the requested investment" do
      investment = Investment.create! valid_attributes
      expect {
        delete :destroy, params: {id: investment.to_param}, session: valid_session
      }.to change(Investment, :count).by(-1)
    end
